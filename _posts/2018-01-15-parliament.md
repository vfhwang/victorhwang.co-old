...
alt="The current website. Unresponsive, cluttered and from a different era." data-echo="{{page.imagesurl}}current-site.png">
...
alt="Our MP page, and matching constituency page" data-echo="{{page.imagesurl}}mp-and-constit.png">
